const checkCSVHeader = require("../js/testing_copies/lca_environmental_copy").checkCSVHeader;
const createPDF = require("../js/testing_copies/lca_environmental_copy").createPDF;
const createResultsFromCSVTable = require("../js/testing_copies/lca_environmental_copy").createResultsFromCSVTable;
const createResultsFromCustomTable = require("../js/testing_copies/lca_environmental_copy").createResultsFromCustomTable;
...
describe.skip('testing the CSV header format', function () {
    ...
    it('should return true if the dataset is in the correct format', function () {
        ...
        let data = [
            ["Indicator", "Mass", "Emission Factor Up" ], 
            ["Pup Example", "10", "10"], 
            ["", "10", "10"]
        ];
...
describe.skip('testing the calculation of indicator values - 3 ', function () {
  ...
  it('should provide value', function () {
      ...
      expect(createResultsFromCSVTable(table_rows_data,3)).to.deep.equal(2000);
  });
