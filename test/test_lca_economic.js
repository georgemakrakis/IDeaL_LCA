const checkCSVHeader = require("../js/testing_copies/lca_economic_copy").checkCSVHeader;
const createPDF = require("../js/testing_copies/lca_economic_copy").createPDF;
const createResultsFromCSVTable = require("../js/testing_copies/lca_economic_copy").createResultsFromCSVTable;
const createResultsFromCustomTable = require("../js/testing_copies/lca_economic_copy").createResultsFromCustomTable;
...
describe.skip('testing the CSV header format', function () {
  ...
  it('should return true if the dataset is in the correct format', function () {
      ...
      let data = [
          ["Indicator", "Raw Material Mass", "Collection/Transportation Cost" ], 
          ["Cup Example", "10", "10"], 
          ["", "10", "10"]
      ];
      expect(checkCSVHeader(data,1)).to.be.true;
  }); 
  
  it('should return false if the dataset does in the correct format in the header', function () {
      // assert.strictEqual(checkCSVHeader(data),true);
      let data = [
        ["Indicator", "Raw Material Mass", "Raw Material Mass" ], 
        ["Cup Example", "10", "10"], 
        ["", "10", "10"]
      ];
      expect(checkCSVHeader(data,1)).to.be.false;
  }); 

  it('should return false if the dataset misses one or more of head fields - 1', function () {
      // assert.strictEqual(checkCSVHeader(data),true);
      let data = [
        ["Indicator", "Raw Material Mass" ], 
        ["Cup Example", "10", "10"], 
        ["", "10", "10"]
      ];
      expect(checkCSVHeader(data,1)).to.be.false;
  ...
  it('should return false if the dataset misses one or more of head fields - 2', function () {
    // assert.strictEqual(checkCSVHeader(data),true);
    let data = [
      ["Indicator", "Raw Material Mass", "Collection/Transportation Cost" ], 
      ["Cup Example", "10", "10", "10"], 
      ["", "10", "10" , "10"]
    ];
    expect(checkCSVHeader(data,3)).to.be.false;
}); 
...
describe.skip('testing the calculation of indicator values - 1 ', function () {
  ...
  it('should not provide values', function () {
      ...
      let table = null;
      expect(createResultsFromCSVTable(table,1)).to.be.null;
  });
  ...
  it('should not provide values - wrong length', function () {
      ...
      expect(createResultsFromCSVTable(table_rows_data,1)).to.be.null;
  });
  ...
  it('should provide value', function () {
      ...
      expect(createResultsFromCSVTable(table_rows_data,1)).to.deep.equal(200);
  });
...
describe.skip('testing the calculation of indicator values - 2 ', function () {
  ...
  it('should not provide values', function () {
      ...
      let table = null;
      expect(createResultsFromCSVTable(table,2)).to.be.null;
  });
  ...
  it('should not provide values - wrong length', function () {
      ...
      expect(createResultsFromCSVTable(table_rows_data,2)).to.be.null;
  });
  ...
  it('should provide value', function () {
      ...
      expect(createResultsFromCSVTable(table_rows_data,2)).to.deep.equal(200);
  });
...
describe.skip('testing the calculation of indicator values - 3 ', function () {
  ...
  it('should not provide values', function () {
      ...
      let table = null;
      expect(createResultsFromCSVTable(table,3)).to.be.null;
  });
  ...
  it('should not provide values - wrong length', function () {
      ...
      expect(createResultsFromCSVTable(table_rows_data,3)).to.be.null;
  });
  ...
  it('should provide value', function () {
      ...
      expect(createResultsFromCSVTable(table_rows_data,3)).to.deep.equal(200);
  });
...
describe('testing the calculation of indicator values from createResultsFromCustomTable', function () {
    ...
    it('should not provide values - empty arrays', function () {
      ...
      expect(createResultsFromCustomTable(masses, costs)).to.be.null;
    });
    ...
    it('should provide values', function () {
      ...
      let costs = [ "10", "10" ];
        ...
        expect(createResultsFromCustomTable(masses, costs)).to.deep.equal(200);
    });
});